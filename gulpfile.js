...
gulp.task('templates', function () {
    return gulp.src(templates.component.files)
        ...
        .pipe(template(templates.component.name, { module:'ftv.components.cnil.templates', standalone:true }))
...
gulp.task('build-js', ['js-component', 'js-libs']);
